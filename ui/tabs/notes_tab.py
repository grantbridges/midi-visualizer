...
class NotesTab(QWidget):
    ...
    def refresh_ui(self):
        ...
        self.note_fadein_start_input.setEnabled(self.vis_config.note_fadein_enabled)
        ...
        self.note_fadein_end_input.setEnabled(self.vis_config.note_fadein_enabled)
        ...
        self.note_fadeout_start_input.setEnabled(self.vis_config.note_fadeout_enabled)
        ...
        self.note_fadeout_end_input.setEnabled(self.vis_config.note_fadeout_enabled)
        ...
        self.note_glow_color.setEnabled(self.vis_config.note_glow_enabled)
        self.note_glow_size_input.setValue(self.vis_config.note_glow_size)
        self.note_glow_size_input.setEnabled(self.vis_config.note_glow_enabled)
        self.note_glow_intensity_input.setValue(self.vis_config.note_glow_intensity)
        self.note_glow_intensity_input.setEnabled(self.vis_config.note_glow_enabled)
        ...
        self.note_highlight_use_vel_checkbox.setEnabled(self.vis_config.note_highlight_enabled)
        self.note_highlight_color.setColor(self.vis_config.note_highlight_color)
        self.note_highlight_color.setEnabled(self.vis_config.note_highlight_enabled)
        self.note_highlight_intensity_input.setValue(self.vis_config.note_highlight_intensity)
        self.note_highlight_intensity_input.setEnabled(self.vis_config.note_highlight_enabled or self.vis_config.note_highlight_use_velocity)
        self.note_highlight_min_intensity_input.setValue(self.vis_config.note_highlight_min_intensity)
        self.note_highlight_min_intensity_input.setEnabled(self.vis_config.note_highlight_enabled or not self.vis_config.note_highlight_use_velocity)
        ...
        self.note_highlight_max_intensity_input.setEnabled(self.vis_config.note_highlight_enabled or not self.vis_config.note_highlight_use_velocity)
        ...
        self.note_sparks_start_dist_input.setEnabled(self.vis_config.note_sparks_enabled)
        self.note_sparks_start_length_input.setValue(self.vis_config.note_sparks_start_length_ratio)
        self.note_sparks_start_length_input.setEnabled(self.vis_config.note_sparks_enabled)
        self.note_sparks_speed_input.setValue(self.vis_config.note_sparks_speed_ratio)
        self.note_sparks_speed_input.setEnabled(self.vis_config.note_sparks_enabled)
        self.note_sparks_speed_var_input.setValue(self.vis_config.note_sparks_speed_var_ratio)
        self.note_sparks_speed_var_input.setEnabled(self.vis_config.note_sparks_enabled)
        self.note_sparks_alpha_input.setValue(self.vis_config.note_sparks_alpha_ratio)
        self.note_sparks_alpha_input.setEnabled(self.vis_config.note_sparks_enabled)
        self.note_sparks_count_input.setValue(self.vis_config.note_sparks_count)
        self.note_sparks_count_input.setEnabled(self.vis_config.note_sparks_enabled)
        self.note_sparks_angle_input.setValue(self.vis_config.note_sparks_max_angle_deg)
        self.note_sparks_angle_input.setEnabled(self.vis_config.note_sparks_enabled)
        self.note_sparks_fade_time_input.setValue(self.vis_config.note_sparks_time_to_fade_sec)
        self.note_sparks_fade_time_input.setEnabled(self.vis_config.note_sparks_enabled)
