...
class NotesTab(QWidget):
    def __init__(self, 
        ...
        self.sparks_alpha_input = QDoubleSpinBox(decimals=2, minimum=0.01, maximum=1.0, singleStep=0.01)
        self.sparks_alpha_input.valueChanged.connect(self._on_changes)
    ...
    def layout_controls(self):
        ...
        LayoutUtil.spinbox(column, "Alpha Ratio", self.sparks_alpha_input)
    ...
    def refresh_ui(self):
        ...
        self.sparks_alpha_input.setValue(self.vis_config.note_sparks_alpha_ratio)
        self.sparks_alpha_input.setEnabled(self.vis_config.note_sparks_enabled)
    ...
    def update_model(self):
        ...
        self.vis_config.note_sparks_alpha_ratio = self.sparks_alpha_input.value()
